...
// Related keyframes/slider styles live in app/globals.css (rh-pulse-btn, rh-slider, rh-hero-tab, rh-option-btn, rh-cat-card, rh-step-input)

import React from 'react';
import { Icon } from './primitives';

export const PulseButton = ({ children, onClick, style, size = 'l' }) => {
  const sizes = {
...
export const HeroBannerV2 = ({ onFindRates, onNavigate }) => {
