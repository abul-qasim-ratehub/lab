...
// Design system: Card, Pill, Icon primitives + semantic colour tokens
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <div style={{
            ...
            letterSpacing: '.14em', color: 'var(--rh-stone-darkest)', marginBottom: 28,
          }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 48, flexWrap: 'wrap' }}>
            {press.map(p => (
              <div key={p.name} style={{
                fontSize: 17, color: 'var(--rh-stone-darkest)', opacity: .6,
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 32, flexWrap: 'wrap', gap: 16 }}>
          <div>
            <h2 style={{ fontSize: 28, fontWeight: 500, margin: '0 0 10px', letterSpacing: '-0.01em' }}>
              Trusted by 12 million Canadians
            </h2>
          ...
          {testimonials.map((t, i) => {
            ...
            return (
              <Card key={i} style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                ...
                <p style={{
                  fontSize: 15, lineHeight: 1.65, color: 'var(--rh-blackberry)',
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--rh-blackberry)' }}>{t.name}</div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    {/* Verified badge */}
                    <span title="Verified review" style={{ display: 'inline-flex', alignItems: 'center', gap: 3, fontSize: 11, color: 'var(--rh-lime-darkest)', fontWeight: 500 }}>
        ...
        {/* ── FSRA / legal trust line ── */}
        <div style={{ marginTop: 24, display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
          <Icon name="maple-leaf" size={18} color="var(--rh-stone-darkest)" />
          <span style={{ fontSize: 12, color: 'var(--rh-stone-darkest)', lineHeight: 1.5 }}>
            Ratehub Inc. is licensed as a mortgage brokerage in all provinces. Ratehub Insurance Services is licensed in ON, AB, and BC.
            Mortgage rates updated as of today. All figures in CAD.
          </span>
        </div>
      </div>
    </section>
