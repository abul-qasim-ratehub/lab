  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('home'); }} style={{ display: 'block', textDecoration: 'none' }}>
          <img src="../../assets/logos/ratehub_full_dark.svg" style={{ height: 26 }} alt="Ratehub.ca" />
        </a>
        <nav style={{ display: 'flex', gap: 4, flex: 1 }}>
          {items.map(it => (
            <a key={it.id} href="#"
              ...
              onMouseEnter={e => e.currentTarget.style.color = 'var(--rh-blueberry-dark)'}
              onMouseLeave={e => e.currentTarget.style.color = current === it.id ? 'var(--rh-blueberry-dark)' : 'var(--rh-blackberry)'}
            >{it.label}</a>
          ))}
        </nav>
