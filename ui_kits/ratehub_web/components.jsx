// Primitives — Button, Anchor, Card, Pill, Tag, Icon
...
const Anchor = ({ children, icon = true, href = '#', ...rest }) => {
...
const Icon = ({ name, size = 24, color = 'currentColor', style }) => (
  <span style={{ display: 'inline-block', width: size, height: size, color, ...style }}>
